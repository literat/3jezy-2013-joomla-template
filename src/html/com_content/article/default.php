...
<?php if (isset($urls) and
        (!empty($urls->urls_position) and $urls->urls_position == '0' or
            $params->get('urls_position') == '0' and empty($urls->urls_position)) or
    empty($urls->urls_position) and !$params->get('urls_position')
) : ?>
...
<?php
    ...
    <?php if (isset($urls) and
        (!empty($urls->urls_position) and $urls->urls_position == '1' or $params->get('urls_position') == '1')
    ) : ?>
    <?php echo $this->loadTemplate('links'); ?>
    <?php endif; ?>
<?php if (!empty($this->item->pagination) and
