...
$doc->addStyleSheet(
    JURI::base() . 'templates/' . $this->template . '/css/position.css',
    $type = 'text/css',
    $media = 'screen,projection'
);
$doc->addStyleSheet(
    JURI::base() . 'templates/' . $this->template . '/css/layout.css',
    $type = 'text/css',
    $media = 'screen,projection'
);
$doc->addStyleSheet(
    JURI::base() . 'templates/' . $this->template . '/css/print.css',
    $type = 'text/css',
    $media = 'print'
);
$doc->addStyleSheet(
    JURI::base() . 'templates/' . $this->template . '/css/general.css',
    $type = 'text/css',
    $media = 'screen,projection'
);
$doc->addStyleSheet(
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
    ...
    <body>
        <div id="all">
            <header id="header">
                ...
                <div><jdoc:include type="modules" name="position-11" style="beezDivision" headerlevel="3" /></div>
    ...
    $logo
            ...
            <content id="<?php echo $showRightColumn ? 'contentarea2' : 'contentarea'; ?>">
                <div id="breadcrumbs">
                    <!--start of position-breadcrumb-->
                    <jdoc:include type="modules" name="position-breadcrumb" />
                    <!--end of position-breadcrumb-->
                </div>
...
<!-- <div id="close">
    ...
    echo 'leftbigger';
                ...
                <div id="mini-nav">
                    ...
                    <!--end of position-mini-nav-->
                </div>
                <div class="wrap"></div>
                </div><!-- end wrapper -->
            </content><!-- end contentarea -->
            <footer id="footer">
                <div id="footer-main"><h4>Napříč Prahou přes 3 jezy</h4><br />
                    Junák - český skaut, středisko Dvojka Praha, z. s.<br />
                    Sídlo: Bělehradská 51, Praha 2, 120 00</div>
                <div id="footer-left">
                    <span></span>
                </div>
                <div id="footer-right">
                    <div><h5>Foto:</h5><div>Martin "Obel" Holcman<br />Václav "Liška" Štěpán</div></div>
                </div>
                <div><jdoc:include type="modules" name="position-10" style="beezDivision" headerlevel="3" /></div>
                <div class="wrap"></div>
            </footer><!-- end footer -->
        </div><!-- all -->
        <!--start of position-measure-->
        <jdoc:include type="modules" name="position-5" style="beezTabs" headerLevel="2"  id="3" />
