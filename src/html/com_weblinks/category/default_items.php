...
<?php if (empty($this->items)): ?>
 ...
 /* if ($canCreate) : // TODO This is not working due to some problem in the router, I think. Ref issue #23685 ?>
    ...
    // open in parent window // Code to add the edit link for the weblink. // Code to add a link to submit a weblink.
    // Compute the correct link
    // open in a new window
    // open in a popup window
    // open in a modal window
    // open in parent window
    // Code to add the edit link for the weblink.
    // Code to add a link to submit a weblink.
    /* if ($canCreate) : // TODO This is not working due to some problem in the router, I think. Ref issue #23685 ?>
        <?php echo JHtml::_('icon.create', $item, $item->params); ?>
     <?php  endif; */
    ?>else: ?>
                ...
                switch ($item->params->get('target', $this->params->get('target'))) {
                    ...
                    case 2:
                        $attribs =
                            ...
                            $this->escape($height) .
                            '';
                        echo "<a href=\"$link\" onclick=\"window.open(this.href, 'targetWindow', '" .
                            $attribs .
                            "'); return false;\">" .
                            $this->escape($item->title) .
                            '</a>';
                    ...
                    case 3:
                        JHtml::_('behavior.modal', 'a.modal'); ?>
                            <a class="modal" href="<?php echo $link; ?>"  rel="{handler: 'iframe', size: {x:<?php echo $this->escape(
    $width
