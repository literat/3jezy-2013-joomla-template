...
var mobileMenu = new Class({
    ...
    createElements: function() {
        var self = this;
        var Openmenu = Joomla.JText._("TPL_3JEZY_OPENMENU");
        var Closemenu = Joomla.JText._("TPL_3JEZY_CLOSEMENU");
        ...
        this.mobile = new Element("div", {
            id: "mobile_select",
            html:
                '<h2><a href=#" id="menuopener" onclick="return false;"><span>Openmenu</span></a></h2>',
            styles: {
                display: "block"
            },
            events: {
